...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def defaultAdmin = new User(firstName:"Site", lastName:"Admin",login:"admin", password:"password",password2:"password",email:"blank@blank.com", age: 0,role: "admin")
		defaultAdmin.save()
		
		def defaultUser = new User(firstName:"Joe", lastName:"Schmo",login:"user", password:"password",password2:"password",email:"user@blank.com", age: 25)
		defaultUser.save()
