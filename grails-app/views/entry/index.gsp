...
<div class="gridContainer clearfix">
  <div id="div1" class="fluid">
		<section id="left">
          ...
          <ul class="points">
            <li>You Have<strong>${session.user.points}</strong></li>
          </ul>
					<div class="sep"></div>
					<ul class="numbers clearfix">
						<li>You've Logged<strong>${session.user.points}</strong></li>
					</ul>
				</div>
			</div>
		...
		<section id="right">
			<div class="gcontent">
				<div class="head"><h1>Trophies</h1></div>
				<div class="boxy">
					<p>Keep excercising to unlock trophies!</p>
					
					<div class="badgeCount">
						<a href="#"><img src="${resource(dir: 'images', file: 'foursquare-badge.png')}" /></a>
						<a href="#"><img src="${resource(dir: 'images', file: 'foursquare-badge.png')}" /></a>
						<a href="#"><img src="${resource(dir: 'images', file: 'foursquare-badge.png')}" /></a>
					</div>
