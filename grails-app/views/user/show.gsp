	...
	<g:if test="${flash.message}">
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.ageBracket}">
				<li class="fieldcontain">
					<span id="ageBracket-label" class="property-label"><g:message code="user.ageBracket.label" default="Age Bracket" /></span>
					
						<span class="property-value" aria-labelledby="ageBracket-label"><g:fieldValue bean="${userInstance}" field="ageBracket"/></span>
